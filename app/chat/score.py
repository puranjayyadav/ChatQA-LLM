...
def random_component_by_score(component_type, component_map):
    ...
    #Loop over the valid names and us them to calculate the average score for each component
...
def score_conversation(
    ...
    client.hincrby("on_retriever_score_counts", retriever, 1)

    client.hincrby("memory_score_values", memory, score)
    client.hincrby("on_memory_score_counts", memory, 1)
